 ...
 * 
 */
@WebServiceClient(name = "BankService", targetNamespace = "http://bsr.bank.pl", wsdlLocation = "http://localhost:8188/soap/BankService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKSERVICE_QNAME = new QName("http://bsr.bank.pl", "BankService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8188/soap/BankService?wsdl");
    ...
    public BankPortType getBankPort() {
        return super.getPort(new QName("http://bsr.bank.pl", "BankPort"), BankPortType.class);
    }
    ...
    public BankPortType getBankPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://bsr.bank.pl", "BankPort"), BankPortType.class, features);
    }
